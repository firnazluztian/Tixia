...
export const HotelCard = ({ hotel }: { hotel: Hotel }) => {
  ...
  return (
    <div
      ...
      className="cursor-pointer rounded-lg shadow-md flex flex-col md:flex-row gap-4 mb-4 border border-gray-200 align-center h-auto"
    >
      {/* Hotel Image */}
      <div className="w-full md:max-w-[20rem] h-48 sm:h-auto relative rounded-lg overflow-hidden">
        <Image
          src={hotel.images[0]}
          alt={hotel.name}
          fill
      ...
      <div className="w-full p-4 sm:py-2 sm:pr-4">
        {/* Hotel Details */}
        <div className="flex-1 flex flex-col justify-between">
          <div>
            ...
            {/* Address */}
            <div className="flex gap-2 mb-4 text-gray-600 items-center align-center">
            ...
            <div className="flex flex-wrap gap-2">
              <div className="px-4 py-2 bg-blue-100 text-blue-600 rounded-lg text-xs">
                Bisa refund
              </div>
              <div className="px-4 py-2 bg-blue-100 text-blue-600 rounded-lg text-xs">
                Bisa reschedule
